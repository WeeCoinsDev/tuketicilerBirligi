      ...
      <Reveal className="grid gap-6 md:gap-7 lg:gap-8 2xl:gap-10" viewport={{ once: true, amount: 0.18 }}>
        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between md:gap-6">
          <div id="home-faq-title" className="max-w-2xl">
            <SectionHeading
              className="[&_h2]:text-balance [&_h2]:text-2xl [&_h2]:leading-[1.08] [&_h2]:md:text-3xl [&_h2]:lg:text-[2rem] [&_h2]:xl:text-4xl [&_h2]:2xl:text-5xl [&_p:first-child]:mb-3 [&_p:first-child]:inline-flex [&_p:first-child]:items-center [&_p:first-child]:gap-2 [&_p:first-child]:rounded-full [&_p:first-child]:border [&_p:first-child]:border-line [&_p:first-child]:bg-white [&_p:first-child]:px-3 [&_p:first-child]:py-1 [&_p:first-child]:text-[11px] [&_p:first-child]:font-medium [&_p:first-child]:tracking-normal [&_p:first-child]:text-muted [&_p:first-child]:shadow-[0_6px_18px_rgba(22,32,51,0.04)] [&_p:first-child]:sm:mb-3.5 [&_p:first-child]:md:mb-4 [&_p:last-child]:mt-3 [&_p:last-child]:max-w-xl [&_p:last-child]:text-sm [&_p:last-child]:leading-6 [&_p:last-child]:sm:mt-3.5 [&_p:last-child]:md:mt-4 [&_p:last-child]:md:text-[15px] [&_p:last-child]:md:leading-7 [&_p:last-child]:2xl:text-base"
              eyebrow={
                <>
