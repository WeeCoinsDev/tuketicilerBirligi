    ...
    lg:[-webkit-mask-image:linear-gradient(to_right,rgba(0,0,0,1)_0%,rgba(0,0,0,1)_35%,rgba(0,0,0,.9)_55%,rgba(0,0,0,.5)_75%,transparent_100%)]"
      ...
      <div className="gridContainer relative z-10 w-full py-16 sm:py-20 md:py-24 lg:py-28">
        <FadeIn className="max-w-xl pr-4 sm:pr-10 lg:max-w-xl xl:max-w-2xl 2xl:max-w-4xl" delay={0.08} duration={0.55} viewport={{ once: true, amount: 0.45 }}>
          ...
          {slide.summary ? (
            <p
              className="mt-4 max-w-md font-sans text-sm leading-6 text-white/70 sm:mt-5 sm:leading-7 md:text-base md:leading-7 lg:leading-8 xl:max-w-lg 2xl:text-lg 2xl:leading-8"
