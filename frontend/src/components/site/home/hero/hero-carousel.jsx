 ...
 * Section uses gridContainer; carousel is .fluid (full bleed), controls re-enter the center column.
 */
export function HeroCarousel({ slides, labels, dateLocale }) {
  ...
  return (
    <section className="gridContainer relative overflow-hidden bg-ink">
      <div className="fluid relative">
        ...
        {items.length > 1 ? (
          <div className="pointer-events-none absolute inset-x-0 bottom-0 z-20 gridContainer">
            <div className="flex items-center gap-5 pb-7 md:pb-9">
