  ...
  return (
    <footer className="border-t border-line bg-ink text-white">
      <div className="gridContainer">
        <div className="grid gap-8 py-10 md:grid-cols-[1.2fr_0.8fr_1fr]">
          <div>
      ...
      <div className="gridContainer border-t border-white/12">
        <div className="flex flex-wrap items-center justify-between gap-3 py-4 text-xs text-white/68">
          <p>
